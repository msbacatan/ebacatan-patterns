...
def add_pattern(pattern_name, category, ingredients, preparation, notes, first_name, last_name):
    pattern_data = {
    ...
    return patterns.insert_one(pattern_data)
...
def initial_database():
    ...
    # add users
    emily = add_user('Emily', 'Bacatan', 'emily@emily.com', 'abc123', 'admin')
    ...
    # add pattern
    chicken_parmesean = add_pattern('Chicken Parmesean', 'Main dishes',
